# Framework Compatibility & Performance

## ADDED Requirements

### Requirement: Laravel 10/11/12 and PHP 8.1–8.4 Support

The system SHALL support Laravel 10.x, 11.x, and 12.x on PHP 8.1 through 8.4 from a single codebase, and a CI matrix SHALL prove the public API and rules work on every supported combination.

#### Scenario: Test matrix is green across versions
- **WHEN** the CI matrix runs PHP {8.1,8.2,8.3,8.4} × Laravel {10,11,12} (via Testbench {8,9,10}, excluding unsupported pairs)
